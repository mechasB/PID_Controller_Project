...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|FAN_Pin|GPIO_PIN_7|READY_LED_Pin
                          |HEAT_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin FAN_Pin PA7 READY_LED_Pin
                           HEAT_LED_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|FAN_Pin|GPIO_PIN_7|READY_LED_Pin
                          |HEAT_LED_Pin;
